...
public class ShieldSwordsMan extends MeleeRole {
    private int defenseCapacity;
    public ShieldSwordsMan(String name, int health, int attackPower, int defenseCapacity, int armor) {
    ...
    protected void onMeleePrepare() {
        System.out.println("🛡️  " + getName() + " 檢查劍與盾的狀態...");
    }
}
